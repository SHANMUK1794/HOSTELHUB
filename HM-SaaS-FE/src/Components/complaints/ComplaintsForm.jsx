...
const ComplaintsForm = ({ setIsOpen, refetch, showToast }) => {
  ...
  const { addComplaint } = useComplaints(selectedYearMonth);
  const [showStatus, setShowStatus] = useState(false);

  const handleInput = (e) => {
    const { name, value } = e.target;
    setComplaintsFormData((prev) => ({ ...prev, [name]: value }));
  };
    ...
    >
        ...
        <div className="flex justify-center items-center mb-4 relative">
          ...
          <button
            ...
            className="absolute top-0 right-0 rounded-full p-1 transition hover:opacity-70"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-2">
            ...
            <input
              ...
              value={complaintsFormData.floor}
          ...
          <div className="mb-2">
            ...
            <input
              ...
              name="room_no"
              placeholder="A101"
              value={complaintsFormData.room_no}
              onChange={handleInput}
              style={{ ...inputStyle, height: "38px" }}
              onFocus={(e) =>
                (e.currentTarget.style.borderColor = "var(--theme-accent)")
          ...
          <div className="mb-2">
            ...
            <input
              ...
              value={complaintsFormData.issue}
              onChange={handleInput}
              style={{ ...inputStyle, height: "38px" }}
              onFocus={(e) =>
                (e.currentTarget.style.borderColor = "var(--theme-accent)")
          ...
          <div className="mb-2">
            ...
            <textarea
              ...
              value={complaintsFormData.issue_description}
              onChange={handleInput}
              style={{
                ...inputStyle,
                height: "60px",
            ...
            <div className="relative w-full">
              <div
                ...
                style={{
                  ...
                  fontFamily: "var(--theme-font-family-primary)",
                  fontSize: "13px",
                  color: complaintsFormData.status
                    ? "var(--theme-primary-text)"
                    : "var(--theme-muted-text)",
                }}
              >
                <span>{complaintsFormData.status || "Select Status"}</span>
                <span
              ...
              {showStatus && (
                <div
                  className="absolute left-0 top-full mt-1 w-full rounded-lg shadow-lg z-50 overflow-hidden"
                  style={{
