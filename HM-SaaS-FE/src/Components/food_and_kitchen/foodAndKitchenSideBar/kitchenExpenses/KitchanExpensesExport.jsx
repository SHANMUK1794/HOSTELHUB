...
import useExport from "../../../../hooks/useExportExpence";
import { BsDownload } from "react-icons/bs";

function KitchanExpensesExport({ branchName, year, month, showToast }) {
  const [showConfirm, setShowConfirm] = useState(false);
  const { useExportExpence } = useExport();
  ...
  const handleDownload = () => {
    ...
    useExportExpence({ branchName, year, month, showToast });
  ...
  return (
    <>
      <button
        ...
        className="text-white px-5 py-2.5 rounded-lg text-sm font-medium flex items-center justify-center gap-2 shadow-sm transition-colors"
...
export default KitchanExpensesExport;
