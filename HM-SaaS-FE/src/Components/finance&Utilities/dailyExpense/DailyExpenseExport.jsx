...
import useDailyExpenseExport from "../../../hooks/useDailyExpenseExport";
import { BsDownload } from "react-icons/bs";

function DailyExpenseExport({ branchName, year, month, showToast }) {
  const [showConfirm, setShowConfirm] = useState(false);
  const { dailyexpense } = useDailyExpenseExport();
  ...
  const handleDownload = () => {
    ...
    dailyexpense({ branchName, year, month });
...
export default DailyExpenseExport;
